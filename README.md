...
Проверяются строковые литералы в вызовах:
...
Для запуска линтера нужно обязательно задать переменную окружения `LINTER_CONFIG` с путем к YAML-файлу конфигурации.
